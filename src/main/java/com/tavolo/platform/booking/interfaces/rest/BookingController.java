...
public class BookingController {
    ...
    public ResponseEntity<BookingResource> createBooking(@RequestBody CreateBookingResource createBookingResource) {
        LOGGER.info("Received create booking request for table ID: {} and booking date: {}",
                createBookingResource.tableId(), createBookingResource.bookingDate());
        ...
        if (bookingOpt.isEmpty()) {
            ...
            LOGGER.error("Booking could not be created for table ID: {}", createBookingResource.tableId());
